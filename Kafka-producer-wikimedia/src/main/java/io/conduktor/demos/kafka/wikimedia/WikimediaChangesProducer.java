...
//        These options are default on kafka 3.0, so I will leave them commented out
//        properties.setProperty(ProducerConfig.ENABLE_IDEMPOTENCE_CONFIG, "true");
//        properties.setProperty(ProducerConfig.ACKS_CONFIG, "all"); // could do -1 instaed of all
//        properties.setProperty(ProducerConfig.RETRIES_CONFIG, Integer.toString(Integer.MAX_VALUE));
//          Could also do Max In FLights =5

//        Setting up higher throughput
